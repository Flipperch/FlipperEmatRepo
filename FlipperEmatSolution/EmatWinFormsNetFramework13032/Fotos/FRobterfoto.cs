...
{
    public partial class frObterfotos : Form
    {
        public frObterfotos()
        {
            InitializeComponent();
        ...
        private void FRobterfoto_Load(object sender, EventArgs e)
        {
            ...
            Configurações.CSconnexoes_txt cs_conf = new Configurações.CSconnexoes_txt();
            cs_conf.get_configuracoes();
            if(cs_conf.conf_video_webcam != string.Empty)
            {
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            if (imgCapture.Image != null)
            {
                ...
                //string a = @"\\SERVMAT\SERVER\DADOS-MATRICULA\FOTOS";
                string a = conf.caminho_fotos;                
                a += numat;
                a += @".png";
                ...
                //imgCapture.Image.Save(fstream, System.Drawing.Imaging.ImageFormat.Png);
        ...
        {
            //if (mouse_clicado == true)
            //{
            //    Alunos.FRcadaluno form1 = (Alunos.FRcadaluno)this.Owner;
            //    form1.retorno_pos_foto();
            //    StopJob();
            //    Close();                
            //}
            //else
        ...
        private void frObterfotos_FormClosing(object sender, FormClosingEventArgs e)
        {
