...
{
    public partial class frHistSituacoes : Form
    {

        csSituacoes cs_situacoes = new csSituacoes();
        csHistoricosSituacoes cs_historicosituacoes = new csHistoricosSituacoes();
        ...
        private void preencher_dgvHistoricoSituacoes()
        {
            ...
            DataTable dt_situacoes = cs_historicosituacoes.sel_historicos_para_exibir(n_mat_pesquisa_);

            DataTable dt_rematriculas = cs_rematriculas.sel_rematriculas_para_exibir(n_mat_pesquisa_);
